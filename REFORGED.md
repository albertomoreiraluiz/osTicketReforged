...
3. [controle de progresso](docs/governance/PROGRESS.md) — ponto atual de retomada;
4. [Plano 0001](docs/plans/active/0001-reverse-engineering.md) — plano ativo da engenharia reversa;
5. [portal documental](docs/index.md) — entrada humana para inventário e evidências;
6. [instruções de automação](.codex/README.md) — configuração isolada das ferramentas de assistência.
