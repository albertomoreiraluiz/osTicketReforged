...
| formulários, campos e listas | metadados/configuração | `include/class.dynamic_forms.php`; `include/class.forms.php:1252-1267,5194-5248`; `include/ajax.forms.php:17-442` | staff, CSRF e validação; widgets/JS internos | médio; limite de novos tipos exige PHP próprio |
...
| aplicação no portal/SCP | app/Signal | `apps/dispatcher.php:23-33`; `scp/apps/dispatcher.php:20-46` | portal ou staff/admin; rota impõe controle local | médio-alto; URLs/controllers/HTML internos |
...
| adicionar AJAX SCP | Signal `ajax.scp` | `scp/ajax.php:25-333`; `AJAX_ROUTE_CATALOG.md` | staff/sessão/CSRF; guarda do objeto é local | alto; 13 alvos ausentes aguardam runtime |
...
| filtro, lista, coluna e export | registries internos | `include/class.filter_action.php:115-737`; `include/class.list.php:138,1119`; `include/class.queue.php:3019-3145`; `include/class.export.php:500,555-809` | opera sobre dados internos; permissão é do chamador | médio-alto; descoberta/lifecycle sem contrato formal |
