...
| GOV-025 | 2026-09-05 | Aceito | Reiniciar o Portão D após descartar a recomendação da PR #28; discutir requisitos e critérios com o responsável antes de nova comparação/recomendação. Preservar histórico, sem herdar primeiro recorte ou aceite dos pareceres anteriores. | solicitação explícita do responsável; ADR 0003; plano ativo |
| GOV-026 | 2026-09-05 | Aceito | O agente principal elabora a primeira disposição de menus e usabilidade do SCP Reforged, sob a direção de dashboard administrativo intuitivo e prioridade funcional; o responsável ajustará o layout posteriormente. A delegação visual não aceita arquitetura pendente nem libera implementação antes do Portão D. | orientação explícita do responsável; Plano 0002 |
...
GOV-023 transforma a arquitetura de informação da PR #25 em regra permanente:
